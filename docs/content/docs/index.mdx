...
import { Rocket, Braces, Tag, ShieldCheck } from "lucide-react";

Teki helps you describe the shape of Java objects and validate them with a small, fluent API. It is designed for teams that like the ergonomics of JavaScript validators such as [Zod](https://zod.dev/) or [Yup](https://github.com/jquense/yup), but want that style inside a Java codebase.
